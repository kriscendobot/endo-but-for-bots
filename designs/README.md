...
*Last updated: 2026-07-17 (revised agentry-git-eval-scenarios for issue #753 item 2: the ReadableBlob fetch, rangeRead, and rangeReadText contract now carries the sed-like filesystem/blob bounded-read affordance, while rendered Git output bounds and remote exo propagation remain follow-ups; summary metadata and M3 notes synced.
