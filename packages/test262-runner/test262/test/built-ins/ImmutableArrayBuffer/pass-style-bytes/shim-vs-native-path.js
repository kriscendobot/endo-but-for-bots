...
description: >
  ...
  This test validates that the observable behavior of frozenBytes and thawnBytes
...
// frozenBytes must produce an immutable-backed Uint8Array via whichever path is active.
var bytes = frozenBytes(new Uint8Array([10, 20, 30]));
...
// thawnBytes must correctly extract bytes from the immutable buffer.
var copy = thawnBytes(bytes);
