/*---
description: >
  frozenBytes wraps a Uint8Array in a hardened frozen Uint8Array backed by an
...
// frozenBytes is exposed on globalThis by the prelude.

var view = new Uint8Array([1, 2, 3, 4, 5]);
var result = frozenBytes(view);
